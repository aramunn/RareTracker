...
local karrAchievements = {
    ...
    ["FR"] = {
        ["Espèces en voie de disparition : Septentrion Morne"] = true,
        ["Espèces en voie de disparition : Terres Maudites Écarlates"] = true,
        ["Espèces en voie de disparition : Unité de confinement R-12"] = true,
        ["Espèces en voie de disparition : Outre-horizon"] = true,
